create schema if not exists desafio_company;
use desafio_company;

select * from information_schema.table_constraints
	where constraint_schema = 'desafio_company';
...
insert into employee values -- ordem correta de supervisores e funcionários
